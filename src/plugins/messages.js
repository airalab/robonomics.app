...
const en = Object.values(services).reduce(function(result, item) {
  return { ...result, [item.meta.id]: item.messages.en };
}, {});
const ru = Object.values(services).reduce(function(result, item) {
  return { ...result, [item.meta.id]: item.messages.ru };
}, {});
