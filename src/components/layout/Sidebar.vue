<template>
  <SidebarPanel>
    ...
    <Item icon="i-menu">
      <Navigation>
        <!-- <NavigationLink :to="{ name: 'home' }" icon="i-cursor">
          {{ $t("menu.home") }}
        </NavigationLink>-->
        <NavigationLink :to="{ name: 'telemetry' }">
          {{ $t("menu.telemetry") }}
        </NavigationLink>
        <NavigationLink :to="{ name: 'services' }">
          {{ $t("menu.services") }}
        </NavigationLink>
        <NavigationLink :to="{ name: 'lighthouseSelect' }">{{
          $t("menu.lighthouses")
        }}</NavigationLink>
